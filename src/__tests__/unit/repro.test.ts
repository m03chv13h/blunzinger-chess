...
import { createInitialState, applyMoveWithRules, canReportGspritzt, canReport, reportGspritzt, getCheckingMoves } from '../../core/blunziger/engine';

describe('G\'spritzt with Atomic + Crazyhouse (issue repro)', () => {
  ...
  it('White should have Qh5+ after 1.e4 f6', () => {
    const fen = 'rnbqkbnr/ppppp1pp/5p2/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2';
    const checkingMoves = getCheckingMoves(fen, null, true); // atomic=true
  ...
  it('full scenario: 1.e4 f6 2.e5 fxe5 - violation detection and G\'spritzt', () => {
    ...
    // Verify Black CAN report before making a move
  ...
  it('same scenario without Atomic overlay - G\'spritzt should still work', () => {
