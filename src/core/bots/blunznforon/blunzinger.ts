/**
 * Blunznforön bot — variant mode filtering (Blunzinger rules).
 *
...
import type { Move, MatchConfig, DropMove, CrazyhouseState, Color, Chess960State } from '../../blunzinger/types';
